...
def check_ball(contour):
    ...
    if (squareness < BALL_SQUARENESS_THRESHOLD and y + h < 480) or contour_area > 3500:  # squareness not applied if ball on lower edge
        return False
    if cy > 340 and contour_area < 800:  # ball is close -> area should be bigger
        return False
    elif 340 >= cy > 200 and (contour_area > 1500 or contour_area < 200):  # ball somewhere in middle -> area should be middle-sized
        return False
